"""
This module aggregates and exports core components related to database connections and configurations.

It includes:
- EncodingType: Enum representing the type of encoding used for data processing.
